    ...
    this.preexistingFeedback = [
      {
        ...
        recommend: 'Yes',
        comments: 'Everything was perfect, from the service to teh quality of the products.'
      },
      {
        rating: '4',
        likes: ['Price'],
      ...
      },
      {
        ...
        recommend: 'Yes',
        comments: 'Absolutely loved everything! Great value for money and friendly staff.'
      }
    ];
  }
